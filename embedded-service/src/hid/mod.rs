...
#![deprecated(
    note = "This interface has been superseded by the relay::hid::HidDevice trait, which is transport-independent, doesn't depend on the comms service, and doesn't require a 'static lifetime on devices."
)]
